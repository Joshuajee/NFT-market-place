...
contract RoyaltyToken is IERC2981, ERC721, ERC721Enumerable, ERC721URIStorage, ERC165Storage, Ownable {
    ...
    function _beforeTokenTransfer(address from, address to, uint256 tokenId, uint price)
        internal
